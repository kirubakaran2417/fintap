...
class FinTapLogo extends StatelessWidget {
  const FinTapLogo({super.key, this.size = 72});
...
class _LogoPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(Offset(size.width * 0.50, size.height * 0.40), size.width * 0.08, Paint()..color = Colors.white);
